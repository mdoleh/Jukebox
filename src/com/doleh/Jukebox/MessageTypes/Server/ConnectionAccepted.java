...
public class ConnectionAccepted extends ServerMessage implements Serializable
{
    ...
    public void Execute()
    {
        NetworkClient.mainActivity.showMessageBox(NetworkClient.mainActivity.getString(R.string.connectionSuccess), NetworkClient.mainActivity.getString(R.string.connectionSuccessMsg));
